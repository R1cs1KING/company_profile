...
class CompanyDetailsIntroAnimation {
    CompanyDetailsIntroAnimation(this.controller)
      ...
      .animate(new CurvedAnimation(parent: controller, curve: new Interval(0.000, 0.500, curve: Curves.ease))),
      bgdropBlur = new Tween(begin: 0.0, end: 5.0)
    .animate(new CurvedAnimation(parent: controller, curve: new Interval(0.000, 0.800, curve: Curves.ease ))),
    avatarSize = new Tween(begin: 0.0, end: 1.0)
    .animate(new CurvedAnimation(parent: controller, curve: new Interval(0.100, 0.400, curve: Curves.elasticInOut))),
    ...
    .animate(new CurvedAnimation(parent: controller, curve: new Interval(0.650, 0.75, curve: Curves.elasticInOut))),
